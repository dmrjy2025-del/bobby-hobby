// SVG Icons that can be replaced with custom logos/graphics
...
export function ShoppingCartIcon({ className, style }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function LanguagesIcon({ className, style }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function TruckIcon({ className, style }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function SettingsIcon({ className, style }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M12 1v6m0 6v6m8.66-12.66l-4.24 4.24m-4.24 4.24l-4.24 4.24m16.48.66h-6m-6 0H1m19.66-8.66l-4.24-4.24m-4.24-4.24L7.34 2.34" />
    </svg>
  );
}
...
export function CakeIcon({ className, style }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
